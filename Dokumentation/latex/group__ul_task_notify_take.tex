...
A task can use ul\+Task\+Notify\+Take() to [optionally] block to wait for a the task\textquotesingle{}s notification value to be non-\/zero. The task does not consume any CPU time while it is in the Blocked state.
