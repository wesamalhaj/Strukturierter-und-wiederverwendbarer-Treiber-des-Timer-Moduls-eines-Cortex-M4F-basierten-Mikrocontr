...
pd\+PASS if the task was successfully created and added to a ready list, otherwise an error code defined in the file \doxyref{projdefs.\+h}{p.}{projdefs_8h_source}
\end{DoxyReturn}
Example usage\+: 
\begin{DoxyPre}
// Task to be created.
