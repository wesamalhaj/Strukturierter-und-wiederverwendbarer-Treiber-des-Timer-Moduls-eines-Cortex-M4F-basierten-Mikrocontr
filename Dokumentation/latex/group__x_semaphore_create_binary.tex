...
In many usage scenarios it is faster and more memory efficient to use a direct to task notification in place of a binary semaphore! {\texttt{ http\+://www.\+freertos.\+org/\+RTOS-\/task-\/notifications.\+html}}
